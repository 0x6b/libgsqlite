...
pub const __MAC_OS_X_VERSION_MAX_ALLOWED: i32 = 120300;
...
pub const SQLITE_SOURCE_ID: &[u8; 85usize] =
    b"2021-12-09 01:34:53 9ff244ce0739f8ee52a3e9671adb4ee54c83c640b02e3f9d185fd2f9a179aapl\0";
...
fn bindgen_test_layout_sqlite3_api_routines() {
    ...
    fn test_field_deserialize() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<sqlite3_api_routines>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).deserialize) as usize - ptr as usize
            },
            2096usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_serialize() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<sqlite3_api_routines>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).serialize) as usize - ptr as usize
            },
            2104usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_db_name() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<sqlite3_api_routines>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).db_name) as usize - ptr as usize
            },
            2112usize,
            concat!(
                "Offset of field: ",
